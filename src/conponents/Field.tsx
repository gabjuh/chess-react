...
const Field: React.FC<FieldType> = ({
  ...
  return (
    <div 
      ...
      className={`select-none relative w-20 h-20 text-white text-center ${piece ? 'cursor-pointer hover:bg-gray-400' : ''} ${isDark ? 'bg-gray-600' : 'bg-gray-500'} ${isHighlighted ? '!bg-green-800 opacity-60' : ''} ${isSelected ? 'border-[3px] border-green-400' : ''}`}>
